    ...
    scrollHeight={scrollHeight}>
        <MobileNavContainer className={`${openNav ? 'open' : 'closed'}`}>
          <MobileNav className={`${openNav ? 'open' : 'closed'}`}>
            <NavLinks>
              <Link href="#who" className="nav-link" style={{ transitionDelay: `${openNav ? '100ms' : '250ms'}` }} offset={-30} to="who" spy={true} smooth={true} delay={400} duration={500} >Quem?</Link>
              <Link href="#what" className="nav-link" style={{ transitionDelay: `${openNav ? '150ms' : '200ms'}` }} offset={-30} to="what" spy={true} smooth={true} delay={400} duration={500} >O Que?</Link>
              <Link href="#work" className="nav-link" style={{ transitionDelay: `${openNav ? '150ms' : '200ms'}` }} offset={-30} to="work" spy={true} smooth={true} delay={400} duration={500} >Como?</Link>
            </NavLinks>
      ...
      <Nav className={`${scrolledTop ? 'top' : 'scrolled'}`}>
        <NavLogo src={scrolledTop ? logoLight : logoDark} alt="Assinatura" />
        <NavButton
